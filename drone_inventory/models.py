...
class Drone(db.Model):
    ...
    def __init__(self, id, name, description, camera_quality, flight_time, max_speed, dimensions, weight, cost_of_prod, series, user_token):
        self.id = self.set_id()
        self.name = name
...
class DroneSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name', 'description', 'camera_quality', 'flight_time', 'max_speed', 'dimensions', 'weight', 'cost_of_prod', 'series', 'user_token']
